    ...
    <footer className="bg-[#e8ecf1]">
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
          ...
          >
            ...
            <ul className="space-y-3 text-[#6C757D]">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+2349130132959" className="hover:text-[#212133]">+234 913 013 2959 (NG)</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="mt-0.5 h-4 w-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-12 border-t border-[#212133]/10 pt-12"
        >
        ...
        >
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="text-[#212133]/70 transition hover:text-[#212133]" aria-label="Twitter">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="#" className="text-[#212133]/70 transition hover:text-[#212133]" aria-label="Facebook">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="#" className="text-[#212133]/70 transition hover:text-[#212133]" aria-label="Instagram">
